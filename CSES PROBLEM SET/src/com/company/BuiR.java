...
class BuiR {
    public static void main(String[] args) throws IOException {
        ...
        ArrayList<Integer> z = g.Connected_Components();

        out.println(z.size()-1);
        for (int i = 1; i < z.size(); i++) out.println(z.get(i-1)+" "+z.get(i));
        out.println();
    ...
    static class Graph {
        ...
        public ArrayList<Integer> Connected_Components(){

            vis = new boolean[x.size()];
        ...
        static void check (int i) {
            ...
            for (int c: x.get(i)) if (!vis[c]) check(c);
        }
    }
