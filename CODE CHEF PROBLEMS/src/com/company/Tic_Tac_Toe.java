...
public class Tic_Tac_Toe {
    ...
    static int[] frequency (String s) {
        ...
        for(int i=0; i<3; i++){
            if(s.charAt(i)!='_' && s.charAt(i)==s.charAt(3+i) && s.charAt(i)==s.charAt(6+i)) {
                if(s.charAt(i)=='X') ret[0]++;
                else ret[1]++;
            }
        }
        for(int i=0; i<7; i+=3){
            if(s.charAt(i)!='_' && s.charAt(i)==s.charAt(1+i) && s.charAt(i)==s.charAt(2+i)) {
                if(s.charAt(i)=='X') ret[0]++;
                else ret[1]++;
            }
        }
        if(s.charAt(0)!='_' && s.charAt(0)==s.charAt(4) && s.charAt(0)==s.charAt(8)) {
            if(s.charAt(0)=='X') ret[0]++;
            else ret[1]++;
        }
        if(s.charAt(2)!='_' && s.charAt(2)==s.charAt(4) && s.charAt(2)==s.charAt(6)) {
            if(s.charAt(2)=='X') ret[0]++;
            else ret[1]++;
        }
