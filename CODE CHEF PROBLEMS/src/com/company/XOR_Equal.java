    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t-->0) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                if (m.containsKey(e)) m.replace(e, m.get(e) + 1);
                else m.put(e, 1L);
            }
            ...
            if (x == 0) {
                ...
                for (Long key: m.keySet()){
                    ...
                    long temp = m.get(key), temp1 = 0L;
                    if (m.containsKey(key^x)) {
                        temp += m.get(key^x);
                        temp1 = m.get(key);
                    }
                    ...
                    else if (max == temp) flip = Math.min(flip,temp1);
                }
            }

            out.println(max+" "+flip);
        }
